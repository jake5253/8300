...
--
-- $Author: hsulliva $
-- $DateTime: 2020/08/18 11:00:52 $
-- $Id: //depot-irv/olympus_partners/dallas_dev/lego_overlay/proprietary/jnap/lualib/devicelist.lua#5 $
--
...
local function toOutputDevice(sc, d, apiVersion)
    ...
    if apiVersion == 2 then
        ...
        for _, mac in ipairs(d.knownMACAddresses) do
            ...
            elseif d.connections and not d.isAuthority then
...
local function innerClearDeviceList(sc, saveProps, apiVersion)
    ...
    return 'OK', (apiVersion == 2) and {} or nil
end
...
function _M.clearDeviceList(sc, saveProps, apiVersion)
    ...
    return innerClearDeviceList(sc, saveProps, apiVersion)
end
